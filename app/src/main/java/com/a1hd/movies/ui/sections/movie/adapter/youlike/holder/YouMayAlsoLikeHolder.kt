package com.a1hd.movies.ui.sections.movie.adapter.youlike.holder
...
class YouMayAlsoLikeHolder(private val binding: ItemDashboardBinding) : RecyclerView.ViewHolder(binding.root) {
